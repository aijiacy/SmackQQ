...
public class TitleComponent extends WebPanel {
    /**
     * Root pane styling com.alee.extended.breadcrumb.icons.
     */
    ...
    protected void updateButtons()
    {
        ...
        {
            minimizeButton = new WebButton( minimizeIcon );
            minimizeButton.setName ( "minimize" );
            minimizeButton.setRolloverIcon(minimizeActiveIcon);
            minimizeButton.setOpaque(false);
            minimizeButton.setVerticalAlignment(SwingConstants.TOP);
            minimizeButton.setPainter(new ColorPainter(new Color(0,0,0,0)));
    ...
    public WebButton getMinimizeButton() {
    ...
    public WebButton getCloseButton(){ return closeButton; }
}
