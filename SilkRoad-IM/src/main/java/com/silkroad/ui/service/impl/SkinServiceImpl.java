...
public class SkinServiceImpl implements SkinService {
    ...
    public static final String DEFAULT_SKIN_DIR = System.getProperty("app.dir",
            System.getProperty("user.dir")) + File.separator + "skins" + File.separator;
    ...
    private Font loadFontFromFile(File file) {
        ...
        try {
            ...
            LOG.warn("invalid font com.alee.extended.breadcrumb.file!", e);
        } catch (IOException e) {
            ...
            if (in != null) {
                try {
                    ...
                    LOG.warn("close font com.alee.extended.breadcrumb.file error!", e);
                }
            }
        }
        return null;
