 ...
 */
public class IMGroupSearchList {
	...
	private List<IMGroupSearchInfo> m_GroupsResult = new ArrayList<IMGroupSearchInfo>();  //搜索出的群集合;
	
	
	public IMGroupSearchList()
	{
	...
	public void setResult(List<IMGroupSearchInfo> groups)
	{
		this.m_GroupsResult = groups;
	}
	
	public List<IMGroupSearchInfo> getResult()
	{
