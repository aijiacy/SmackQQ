...
public class IMGroup implements Serializable {
	...
	private List<IMGroupMember> members = new ArrayList<IMGroupMember>();
	 ...
	 *            the members to set
	 */
	public void setMembers(List<IMGroupMember> members) {
	...
	public IMGroupMember getMemberByUin(long uid){
		for(IMGroupMember mem: members){
			if(mem.getUid() == uid){
				return mem;
			}
		}
	...
	public String toString() {
		return "IMGroup [gid=" + gid + ", code=" + code + ", name=" + name + "]";
	}
