...
public enum IMEventType {
	...
	CLIENT_ONLINE,	//客户端在线
	/********登录部分*******/
    USER_REG_REQUEST,//注册申请
    USER_REG_SUCCESS,//注册成功
    USER_REG_ERROR,  //注册失败
	LOGIN_READY_REQUEST,//准备登录
    LOGIN_READY_SUCCESS,//准备登录
    LOGIN_READY_ERROR,//准备登录
	LOGIN_REQUEST,	//登录请求
	LOGIN_PROGRESS, //登录进度
	LOGIN_ERROR, 	//登录失败
	LOGIN_SUCCESS,	//登录成功
    ...
    /*******************/
    GET_OFFLINE_MSG_REQUEST,
    CHANGE_RECV_MSG_LANGUAGE,
