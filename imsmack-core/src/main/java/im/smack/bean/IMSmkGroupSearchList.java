 ...
 */
public class IMSmkGroupSearchList {
	...
	private List<IMSmkGroupSearchInfo> m_GroupsResult = new ArrayList<IMSmkGroupSearchInfo>();  //搜索出的群集合;
	
	
	public IMSmkGroupSearchList()
	{
	...
	public void setResult(List<IMSmkGroupSearchInfo> groups)
	{
		this.m_GroupsResult = groups;
	}
	
	public List<IMSmkGroupSearchInfo> getResult()
	{
