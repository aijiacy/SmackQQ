 ...
 * 
 */
public class IMSmkGroup implements Serializable {
	...
	private List<IMSmkGroupMember> members = new ArrayList<IMSmkGroupMember>();
	 ...
	 * @return the members
	 */
	public List<IMSmkGroupMember> getMembers() {
		return members;
	}
	 ...
	 *            the members to set
	 */
	public void setMembers(List<IMSmkGroupMember> members) {
	...
	public IMSmkGroupMember getMemberByUin(long uid){
		for(IMSmkGroupMember mem: members){
			if(mem.getUid() == uid){
				return mem;
			}
		}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof IMSmkGroup) {
			IMSmkGroup g = (IMSmkGroup) obj;
